...
public interface CategoryRepository extends JpaRepository<Category, Long> {
    ...
    boolean existsCategoryByNameAndNotId(@NotEmpty(message = "El nombre no puede estar vacío.") @Size(min = 2, max = 100, message = "El nombre debe tener entre 2 y 100 caracteres.") String name, Long id);
}