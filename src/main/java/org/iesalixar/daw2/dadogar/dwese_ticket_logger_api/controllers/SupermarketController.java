...
public class SupermarketController {
    ...
    public String insertSupermarket(@Valid @ModelAttribute("supermarket") Supermarket supermarket, BindingResult result, RedirectAttributes redirectAttributes, Locale locale) {
        ...
        supermarketDAO.insertSupermarket(supermarket); // Insertar el nuevo supermercado
    ...
    public String showEditForm(@RequestParam("id") int id, Model model) {
        ...
        Supermarket supermarket = supermarketDAO.getSupermarketById(id); // Obtener el supermercado por ID
        model.addAttribute("supermarket", supermarket); // Pasar el supermercado al modelo
        return "supermarket-form"; // Nombre de la plantilla Thymeleaf para el formulario
    }
    ...
    public String updateSupermarket(@Valid @ModelAttribute("supermarket") Supermarket supermarket,
        ...
        supermarketDAO.updateSupermarket(supermarket); // Actualizar el supermercado
    ...
    public String deleteSupermarket(@RequestParam("id") int id, RedirectAttributes redirectAttributes) {
        ...
        supermarketDAO.deleteSupermarket(id); // Eliminar el supermercado
