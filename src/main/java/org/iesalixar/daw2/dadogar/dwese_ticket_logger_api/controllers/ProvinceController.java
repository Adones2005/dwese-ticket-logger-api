...
import org.iesalixar.daw2.dadogar.dwese_ticket_logger_webapp.dao.RegionDAO;
...
public class ProvinceController {
    ...
    public String showEditForm(@RequestParam("id") int id, Model model) {
        ...
        Province province = provinceDAO.getProvinceById(id); // Obtener la provincia por ID
        List<Region> listRegions = regionDAO.listAllRegions(); // Obtener la lista de regiones
    ...
    public String insertProvince(@Valid @ModelAttribute("province") Province province, BindingResult result, RedirectAttributes redirectAttributes, Locale locale) {
        ...
        provinceDAO.insertProvince(province); // Insertar la nueva provincia
    ...
    public String updateProvince(@Valid @ModelAttribute("province") Province province, BindingResult result, RedirectAttributes redirectAttributes, Locale locale) {
        ...
        provinceDAO.updateProvince(province); // Actualizar la provincia
    ...
    public String deleteProvince(@RequestParam("id") int id, RedirectAttributes redirectAttributes) {
        ...
        provinceDAO.deleteProvince(id); // Eliminar la provincia
