...
import org.iesalixar.daw2.dadogar.dwese_ticket_logger_api.dto.CategoryCreateDTO;
import org.iesalixar.daw2.dadogar.dwese_ticket_logger_api.dto.CategoryDTO;
import org.iesalixar.daw2.dadogar.dwese_ticket_logger_api.services.CategoryService;
...
public class CategoryController {
     ...
     *
     * @param createDTO DTO con los datos para crear la categoria.
    ...
    public ResponseEntity<?> createCategory(
        ...
        try {
            ...
            logger.warn("Error al crear la categoria: {}", e.getMessage());
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(e.getMessage());
        } catch (RuntimeException e) {
            logger.error("Error al guardar la imagen: {}", e.getMessage());
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Error al guardar la imagen.");
        } catch (Exception e) {
            logger.error("Error inesperado al crear la categoria: {}", e.getMessage());
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Error al crear la categoria.");
        }
    }
